...
import type { QRVerificationRequest, QRVerificationResponse } from "../../types/qr-verification";

export async function verifyQRToken(request: QRVerificationRequest): Promise<QRVerificationResponse> {
