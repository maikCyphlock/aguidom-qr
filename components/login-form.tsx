        ...
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="grid gap-2">
              ...
              <Input id="email" type="email" placeholder="tucorreo@ejemplo.com" required value={form.email} onChange={handleChange("email")} />
            </div>

            <div className="grid gap-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="password">Contraseña</Label>
                <a onClick={() => navigateTo("/auth/forgot-password")} className="text-sm text-muted-foreground hover:underline cursor-pointer">
          ...
          <p className="mt-4 text-sm text-center text-muted-foreground">
            ¿No tienes cuenta?{" "}
            <a href="/auth/sign-up" className="text-primary hover:underline cursor-pointer">
              Regístrate
            </a>
          </p>
        </CardContent>
