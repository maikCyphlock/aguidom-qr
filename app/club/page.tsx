...
export default function AguidomAttendanceSystem() {
  ...
  const recentAttendance = [
    { id: '1', member: 'Juan Pérez', club: 'Club Central', time: '14:32', status: 'Presente' },
    { id: '2', member: 'María García', club: 'Club Norte', time: '14:28', status: 'Presente' },
    { id: '3', member: 'Carlos López', club: 'Club Sur', time: '14:25', status: 'Presente' },
    { id: '4', member: 'Ana Martín', club: 'Club Este', time: '14:20', status: 'Presente' }
  ];

  const members = [
    { id: '1', name: 'Juan Pérez', club: 'Club Central', status: 'Presente', qr: 'QR001' },
    { id: '2', name: 'María García', club: 'Club Norte', status: 'Presente', qr: 'QR002' },
    { id: '3', name: 'Carlos López', club: 'Club Sur', status: 'Presente', qr: 'QR003' },
    { id: '4', name: 'Ana Martín', club: 'Club Este', status: 'Presente', qr: 'QR004' },
    { id: '5', name: 'Luis Rodríguez', club: 'Club Central', status: 'Ausente', qr: 'QR005' },
    { id: '6', name: 'Sofia Hernández', club: 'Club Norte', status: 'Ausente', qr: 'QR006' }
  ];
  ...
  const handleQRScan = () => {
    ...
    setScanResult(`Asistencia registrada: ${randomMember.name} - ${randomMember.club}`);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">CLUB AGUIDOM</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-black">{totalMembers}</div>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="pb-3">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-red-600">{totalMembers - totalPresent}</div>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="pb-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Estado actual de asistencias por club</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div key={club.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{club.members} miembros totales</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-lg font-semibold text-green-600">{club.present}</p>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Escanea el código QR del miembro para registrar asistencia</CardDescription>
              </CardHeader>
                  ...
                  {recentAttendance.map(record => (
                    <div key={record.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">{record.member}</p>
                  ...
                  {filteredMembers.map(member => (
                    <div key={member.id} className="flex items-center justify-between p-4 border rounded-lg">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="text-right">
                          <p className="text-sm font-medium text-gray-900">QR: {member.qr}</p>
                          <p className={`text-sm ${
                            member.status === 'Presente' ? 'text-green-600' : 'text-red-600'
                          }`}>
                            {member.status}
                          </p>
                        </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Histórico de asistencias de hoy</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {recentAttendance.map(record => (
                    <div key={record.id} className="flex items-center justify-between p-4 border rounded-lg">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-sm text-green-600">Acceso autorizado</p>
                      </div>
                    </div>
                  ))}
                </div>
